...
apt install -y macbuntu-os-plank-theme-lts-v8 && let progress++ && echo "[*] [ $progress/$total ] Installed macbuntu-os-plank-themes"
apt install -y macbuntu-os-icons-lts-v8 && let progress++ && echo "[*] [ $progress/$total ] Installed macbuntu-os-icons-lts"
apt install -y macbuntu-os-ithemes-lts-v8 && let progress++ && echo "[*] [ $progress/$total ] Installed macbuntu-os-ithemes"
...
file=vbox.deb
if [ ! -f $apps/$file ]; then
	wget -q -O $apps/$file "http://download.virtualbox.org/virtualbox/5.1.26/virtualbox-5.1_5.1.26-117224~Ubuntu~yakkety_amd64.deb"
